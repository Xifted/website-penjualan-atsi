<header id="header" class="header fixed-top bg-white" data-scrollto-offset="0">
    <div class="container-fluid d-flex align-items-center justify-content-between px-5">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                <li>
                    <a class="nav-link" href="/#hero">{{ session()->get('locale') == 'en' ? 'Home Page' : 'Halaman Beranda' }}</a>
                </li>
                <li>
                    <a class="nav-link" href="/#about">{{ session()->get('locale') == 'en' ? 'About Us' : 'Tentang Kami' }}</a>
                </li>
                <li class="dropdown">
                    <a href="#">
                ...
                <li>
                    <a class="nav-link" href="/products#products">{{ session()->get('locale') == 'en' ? 'Products' : 'Produk' }}</a>
                </li>
                <li>
        ...
        <a class="btn-getstarted scrollto" href="#">{{ session()->get('locale') == 'en' ? 'Get Started' : 'Gabung Sekarang' }}</a>
    </div>
</header>

<footer id="footer" class="footer">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <p class="mt-3">
                ...
                <!-- NY 535022, USA<br /><br /> -->
                <strong>Phone:</strong> (0251) 123456<br />
    ...
    <div class="footer-legal text-center">
      ...
      >
        ...
        >
          <div class="copyright">
            &copy; Copyright <strong><span>PT ATLANTIS SERVICE INDONESIA</span></strong
            >. All Rights Reserved
          </div>
          <div class="credits">
            ...
            Designed by <a href="https://github.com/Xifted">Rafi</a>
          </div>
        </div>

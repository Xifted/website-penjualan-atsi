<div class="carousel-item <?= $active ?? false ? 'active' : '' ?>" style="overflow: visible">
    {{-- <img src="{{ asset("/assets/img/hero-carousel/$image") }}" class="img-fluid carousel-img"> --}}
    <div class="carousel-img"
        style="background: right / cover no-repeat url('{{ asset("/assets/img/hero-carousel/$image") }}')"></div>
